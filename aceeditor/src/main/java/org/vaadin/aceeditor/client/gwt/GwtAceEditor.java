...
public class GwtAceEditor extends JavaScriptObject {
	...
	public static native GwtAceEditor create(Element parent, String editorId) /*-{
		...
		aceDiv.get_editor = function() {return editor;}
	...
	public final native void addChangeHandler(GwtAceChangeHandler handler) /*-{
		var cb = function(event) {
			handler.@org.vaadin.aceeditor.client.gwt.GwtAceChangeHandler::onChange(Lorg/vaadin/aceeditor/client/gwt/GwtAceChangeEvent;)(event);
		}
	...
	public final native void addChangeCursorHandler(
		...
		var cb = function(event) {
			handler.@org.vaadin.aceeditor.client.gwt.GwtAceChangeCursorHandler::onChangeCursor(Lorg/vaadin/aceeditor/client/gwt/GwtAceEvent;)(event);
		}
	...
	public final native void addChangeSelectionHandler(
		...
		var cb = function(event) {
			handler.@org.vaadin.aceeditor.client.gwt.GwtAceChangeSelectionHandler::onChangeSelection(Lorg/vaadin/aceeditor/client/gwt/GwtAceEvent;)(event);
		}
	...
	public final native void addFocusListener(GwtAceFocusBlurHandler handler) /*-{
		var focus = function(event) {
			handler.@org.vaadin.aceeditor.client.gwt.GwtAceFocusBlurHandler::onFocus(Lorg/vaadin/aceeditor/client/gwt/GwtAceEvent;)(event);
		}
		var blur = function(event) {
			handler.@org.vaadin.aceeditor.client.gwt.GwtAceFocusBlurHandler::onBlur(Lorg/vaadin/aceeditor/client/gwt/GwtAceEvent;)(event);
		}
